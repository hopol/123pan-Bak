#!/usr/bin/env bash
# 手动镜像 123panNextGen/123pan 的 fluent-dev 分支。
set -euo pipefail

UPSTREAM_URL="https://github.com/123panNextGen/123pan.git"
UPSTREAM_WEB_URL="https://github.com/123panNextGen/123pan"
UPSTREAM_BRANCH="fluent-dev"
MIRROR_REPO="https://github.com/hopol/123pan-Bak"
...
git add upstream
git commit -m "chore: mirror 123pan-Bak source $SOURCE_VALUE ($SHORT_COMMIT)"
git tag -a "mirror-source-$SHORT_COMMIT" -m "Mirror 123pan-Bak source $SOURCE_VALUE ($SHORT_COMMIT)"
git push origin HEAD
git push origin "mirror-source-$SHORT_COMMIT"
echo "已同步 123pan-Bak $UPSTREAM_BRANCH：$UPSTREAM_COMMIT"
